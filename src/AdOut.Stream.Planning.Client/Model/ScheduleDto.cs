...
namespace AdOut.Stream.Planning.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ScheduleDto :  IEquatable<ScheduleDto>
    {
        /// <summary>
        ...
        public ScheduleDto(ScheduleType type = default(ScheduleType), string startTime = default(string), string endTime = default(string), string breakTime = default(string), string playTime = default(string), DayOfWeek dayOfWeek = default(DayOfWeek), DateTime? date = default(DateTime?))
        {
            this.Type = type;
