...
namespace AdOut.Stream.Planning.Client.Client
{
        ...
        public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = AdOut.Stream.Planning.Client.Client.Configuration.Default;
            RestClient = new RestClient("https://{host}:{port}/api/{version}");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://{host}:{port}/api/{version}).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? AdOut.Stream.Planning.Client.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://{host}:{port}/api/{version}")
        {
        ...
        public FileParameter ParameterToFile(string name, System.IO.Stream stream)
        {
